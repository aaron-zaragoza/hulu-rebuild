...
function SiteDescription() {
    return (
        <div className="site__description">
            ...
            <p>This project was inspired by the popular movie and television streaming app, Hulu. This project features movies and television shows provided by the IMTB API and is regularly updated to feature relevant titles that viewers may be familiar with.</p>
            ...
            <p><strong>Moving Forward: </strong>I plan to make all buttons functional and potentially developing the back end in the near future, thus allowing for personalized content and themes to enhance the user experience. Please stay tuned as these additional features roll out and I look forward to sharing updates!</p>
